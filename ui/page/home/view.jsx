    ...
    <Page fullWidthPage>
      <div className="notice-message--loud">
        ...
        <p className="section__subtitle">
          <ul>{addItem('Mobile Overall Style Changes')}</ul>
          <ul>{addItem('Livestream Chat and Comment Section Swipeable Drawer')}</ul>
          <ul>{addItem('Video plays as Fixed Position while on page')}</ul>
          <ul>{addItem('Use modals for tip selectors')}</ul>
        </p>
      </div>
